...
class Level:
    def __init__(self, window: Surface, level: int, game_mode: str, player_score: list[int]): # +Alterei de name para level
        self.name = "Level" + str(level) # +
        self.timeout = TIMEOUT_LEVELS[level-1] # +
        self.window = window
